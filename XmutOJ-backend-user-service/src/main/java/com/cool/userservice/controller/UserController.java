package com.cool.userservice.controller;
...
import com.cool.backendmodel.model.dto.user.*;
import com.cool.backendmodel.model.entity.User;
import com.cool.backendmodel.model.vo.LoginUserVO;
import com.cool.backendmodel.model.vo.UserVO;
import com.cool.userservice.service.UserService;
...
public class UserController {
    ...
    public BaseResponse<Boolean> updateUser(@RequestBody UserUpdateRequest userUpdateRequest,
        ...
        User user = new User();
        //如果账号被封则设置密码为null,如果账号被注销则设置密码为null
        if (userUpdateRequest.getUserState().equals("封号") || userUpdateRequest.getUserState().equals("注销")) {
            userUpdateRequest.setUserPassword("null");
        }
